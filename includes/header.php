...
<head>
  ...
  <style>
    ...
    #fhSplash{
      ...
      justify-content:center;
      background:
        radial-gradient(900px 520px at 12% 18%, rgb(var(--fh-brand-rgb) / .26), transparent 62%),
        radial-gradient(820px 520px at 92% 10%, rgb(var(--fh-accent-rgb) / .22), transparent 64%),
