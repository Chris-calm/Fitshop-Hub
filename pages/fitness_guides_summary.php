...
try {
  ...
  echo '<section class="text-red-400">Failed to save guide: '.htmlspecialchars($e->getMessage()).'</section>';
  exit;
}
?>
<section>
  <h2 class="text-2xl font-bold mb-2">Guide Summary</h2>
  <div class="rounded-xl border border-neutral-800 bg-neutral-900 p-4 mb-4">
    ...
    <div class="mt-2 grid grid-cols-2 md:grid-cols-4 gap-4">
      ...
      <div>
        <div class="text-neutral-400 text-sm">Cues Completed</div>
  ...
  <div class="flex items-center gap-3">
    <a href="index.php?page=guides" class="px-4 py-2 rounded-lg bg-neutral-800">Back to Guides</a>
    <a href="index.php?page=guide_detail&id=<?= urlencode($item_id) ?>" class="px-4 py-2 rounded-lg bg-brand text-white">Repeat Guide</a>
  </div>
</section>
